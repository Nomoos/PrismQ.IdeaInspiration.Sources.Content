...
class Database:
    ...
    def get_idea(self, source: str, source_id: str) -> Optional[Dict[str, Any]]:
        ...
        with db_utils.get_connection(self.database_url) as conn:
            ...
            result = conn.execute(
                text("SELECT * FROM MediumSource WHERE source = :source AND source_id = :source_id"),
    ...
    def get_all_ideas(self, limit: int = 20) -> List[Dict[str, Any]]:
        ...
        """
        return db_utils.get_all_ideas(self.database_url, limit)
