"""Instagram Hashtag plugin for scraping reels by hashtag.

This plugin scrapes Instagram Reels based on hashtag search.
"""
...
class InstagramHashtagPlugin(SourcePlugin):
    """Plugin for scraping reels by hashtag."""
    ...
    def get_source_name(self) -> str:
        ...
        Returns:
            Source name
        """
        return "instagram_reels_hashtag"
    ...
    def scrape_hashtag(self, hashtag: str, max_reels: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        if max_reels is None:
            max_reels = getattr(self.config, 'instagram_hashtag_max_reels', 50)
        ...
        print(f"Scraping reels for hashtag: #{hashtag} (max: {max_reels})...")
        ...
        try:
            ...
            for post in hashtag_obj.get_posts():
                ...
                # Check if it's a reel (video with short duration)
    ...
    def scrape(self, hashtag: Optional[str] = None, max_reels: Optional[int] = None) -> List[Dict[str, Any]]:
        """Main scrape method.
        ...
        return self.scrape_hashtag(hashtag, max_reels=max_reels)
