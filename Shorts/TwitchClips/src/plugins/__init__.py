...
class SourcePlugin(ABC):
    ...
    def get_source_name(self) -> str:
        ...
        Returns:
            Source name (e.g., 'twitch_clips', 'twitch_game')
        """
        pass
...
from .twitch_trending_plugin import TwitchTrendingPlugin
from .twitch_game_plugin import TwitchGamePlugin
from .twitch_streamer_plugin import TwitchStreamerPlugin

__all__ = [
    "SourcePlugin",
    "TwitchTrendingPlugin",
    "TwitchGamePlugin",
    "TwitchStreamerPlugin",
]
