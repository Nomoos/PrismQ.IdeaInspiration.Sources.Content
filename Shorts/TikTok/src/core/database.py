"""Database wrapper for TikTok source.

This module provides backward compatibility with the original Database class
by wrapping the db_utils module that uses DATABASE_URL.
"""
...
class Database:
    """Manages database operations for TikTok idea collection.
    ...
    def get_idea(self, source: str, source_id: str) -> Optional[Dict[str, Any]]:
        ...
        """
        return db_utils.get_idea(self.database_url, source, source_id)
    
    def get_all_ideas(self, source: Optional[str] = None, 
        ...
        """
        return db_utils.get_all_ideas(self.database_url, source, processed)
    
    def mark_processed(self, source: str, source_id: str) -> bool:
        ...
        """
        return db_utils.mark_processed(self.database_url, source, source_id)
    ...
    def get_statistics(self) -> Dict[str, Any]:
        ...
        """
        return db_utils.get_statistics(self.database_url)
