"""HackerNews Frontpage plugin for scraping top stories."""
...
class HNFrontpagePlugin(SourcePlugin):
    """Plugin for scraping top stories from HackerNews frontpage.
    ...
    def __init__(self, config):
        """Initialize HackerNews frontpage plugin.
    ...
    def scrape(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        """
        return self.scrape_topstories(limit=limit)
    
    def scrape_topstories(self, limit: Optional[int] = None) -> List[Dict[str, Any]]:
        ...
        if limit is None:
            limit = self.config.hn_frontpage_max_posts
        
        print(f"Scraping {limit} top stories from HackerNews...")
        ...
        try:
            ...
            print(f"\nSuccessfully scraped {len(ideas)} stories")
